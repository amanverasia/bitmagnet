...
go build -ldflags "-s -w -X github.com/amanverasia/bitmagnet/internal/version.GitTag=${VERSION}" -o /build/bitmagnet main.go

# build runner
FROM alpine:latest AS runner

LABEL org.opencontainers.image.source = "https://github.com/amanverasia/bitmagnet"
