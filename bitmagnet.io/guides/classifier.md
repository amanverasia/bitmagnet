...
The classifier is declared in YAML format. The application includes a [core classifier](https://github.com/amanverasia/bitmagnet/blob/main/internal/classifier/classifier.core.yml) that can be configured, extended or completely replaced with a custom classifier. This page documents the required format.
...
- [the core classifier](https://github.com/amanverasia/bitmagnet/blob/main/internal/classifier/classifier.core.yml)
...
For more details on the protocol buffer types, please refer to [the protobuf schema](https://github.com/amanverasia/bitmagnet/blob/main/internal/protobuf/bitmagnet.proto).
